...
class respostas_avaliacoes extends StatefulWidget {
  ...
  @override
  State<respostas_avaliacoes> createState() => _respostas_avaliacoesState();
}

class _respostas_avaliacoesState extends State<respostas_avaliacoes> {
