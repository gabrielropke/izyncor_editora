...
import 'package:editora_izyncor_app/interior_usuario/homepage/novidades/respostas_comentarios.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:readmore/readmore.dart';

class comentarios_novidades extends StatefulWidget {
  final String titulo;

  const comentarios_novidades({Key? key, required this.titulo})
      : super(key: key);

  @override
  _comentarios_novidadesState createState() => _comentarios_novidadesState();
}

class _comentarios_novidadesState extends State<comentarios_novidades> {
  late String titulo;
  ...
  Future<String?> getUidUsuario(String titulo) async {
    try {
      DocumentReference livroRef =
          FirebaseFirestore.instance.collection('novidades').doc(titulo);
