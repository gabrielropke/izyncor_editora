...
class postagem_textos extends StatefulWidget {
  final String nome;
  const postagem_textos({super.key, required this.nome});

  @override
  State<postagem_textos> createState() => _postagem_textosState();
}

class _postagem_textosState extends State<postagem_textos> {
                ...
                return Center(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Você não compartilhou seus pensamentos',
                          style: TextStyle(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                        ...
                        child: Column(
                          children: [
                            if (postagem['autorId'] == idUsuarioLogado)
                              Column(
                                children: [
                                  Visibility(
