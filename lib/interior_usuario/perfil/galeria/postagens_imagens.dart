...
class postagem_imagens extends StatefulWidget {
  const postagem_imagens({super.key});

  @override
  State<postagem_imagens> createState() => _postagem_imagensState();
}

class _postagem_imagensState extends State<postagem_imagens> {
