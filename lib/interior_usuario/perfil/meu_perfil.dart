...
import 'package:editora_izyncor_app/interior_usuario/perfil/galeria/postagens.dart';
import 'package:editora_izyncor_app/interior_usuario/perfil/galeria/salvos.dart';
            ...
            Padding(
              ...
              child: ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const home_config()));
                },
              ),
            ),
            ListTile(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Padding(
                ...
                child: Text(biografia, style: const TextStyle(fontSize: 18),),
              ),
            ),
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              ...
                              errorWidget: (context, url, error) =>
                                  const Icon(Icons.error, color: Colors.white,), // widget de erro
                            ),
                          ),
                        ),
                      ),
                ...
                child: Container(
                  ...
                  child: TabBar(
                      ...
                      tabs: const [
                        ...
                        Tab(
                          child: Icon(Icons.bookmark_added, size: 23),
                        ),
                      ]),
                ),
              ),
