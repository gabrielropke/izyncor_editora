...
class seguindo_page extends StatefulWidget {
  const seguindo_page({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _seguindo_pageState createState() => _seguindo_pageState();
}

// ignore: camel_case_types
class _seguindo_pageState extends State<seguindo_page> {
