...
class postagens_textos_visita extends StatefulWidget {
  final String autoId;
  final String nome;
  const postagens_textos_visita(
      {super.key, required this.nome, required this.autoId});

  @override
  State<postagens_textos_visita> createState() =>
      _postagens_textos_visitaState();
}
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return const Text("Erro ao carregar dados do Firestore");
                  ...
                  doc['autorId'] == autorId && doc['imagemUrl'] == 'vazio')) {
                return Center(
                    child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('$nome não compartilhou seus pensamentos ainda...',
