...
class postagens_imagens_visita extends StatefulWidget {
  final String autoId;
  const postagens_imagens_visita({super.key, required this.autoId});

  @override
  State<postagens_imagens_visita> createState() => _postagens_imagens_visitaState();
}

class _postagens_imagens_visitaState extends State<postagens_imagens_visita> {
